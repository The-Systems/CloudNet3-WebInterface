                ...
                <li class="relative">
                    <div x-data="{ dropdownOpen: false }">
                        ...
                        <div x-show="dropdownOpen"
                            ...
                            ?>
                            <a href="<?= \webinterface\main::getUrl() . '/profile'; ?>"
                               class="block px-4 py-2 text-sm capitalize text-gray-800 hover:bg-indigo-500 hover:text-white">
                                <?= $name ?>
                            </a>
                            <a href="<?= \webinterface\main::getUrl() . '/profile/help'; ?>"
                               class="block px-4 py-2 text-sm capitalize text-gray-800 hover:bg-indigo-500 hover:text-white">
                                Help
                            </a>
                            <a href="<?= \webinterface\main::getUrl() . '/profile/settings'; ?>"
                               class="block px-4 py-2 text-sm capitalize text-gray-800 hover:bg-indigo-500 hover:text-white">
                                Settings
                            </a>
                            <a href="<?= \webinterface\main::getUrl() . '/logout'; ?>"
                               class="block px-4 py-2 text-sm capitalize text-gray-800 hover:bg-indigo-500 hover:text-white">
                                Logout
                            </a>
                        </div>
